...
var user = function (name , age , salary ) // constructor 
{
    this.name = name;
    this.age = age;
    this.salary =  salary;
...
var ahmed = new user('ahmed' , 26 , 2500 );
var ali = new user('ali' , 28 , 3500 );
var john = new user('john' , 27 , 2900 );
...
let ali = new user ('ali' , 27 , 8000);
let sayed = new user ('sayed' , 28 , 6000);
let mai = new user ('mai' , 17 , 1000);
mai.welcome();

class engineer extends user 
{
    constructor (name , age , salary , department , company )
    {
...
var darsh = new engineer("mostafa" , 25 , 8000 , 'software ' , 'Dell');
